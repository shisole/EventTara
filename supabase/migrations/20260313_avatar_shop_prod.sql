-- =============================================================================
-- Avatar Shop, TaraTokens & Cosmetic Shop — Combined Production Migration
-- Single file that sets up the entire feature from scratch.
-- =============================================================================
...
-- ============================================================
-- 5. shop_items — items catalog (includes 'animal' category)
-- ============================================================
CREATE TABLE IF NOT EXISTS shop_items (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  slug text UNIQUE NOT NULL,
  name text NOT NULL,
  category text NOT NULL CHECK (category IN ('accessory', 'animal', 'background', 'border', 'skin')),
  image_url text NOT NULL,
  preview_url text,
...
-- ============================================================
-- 12. Seed: shop items — animals (8) — 25 tokens each
-- ============================================================
...
-- ============================================================
-- 13. Seed: shop items — accessories (5)
-- ============================================================
INSERT INTO shop_items (slug, name, category, image_url, price, rarity, sort_order) VALUES
...
-- ============================================================
-- 14. Seed: shop items — backgrounds (4)
-- ============================================================
INSERT INTO shop_items (slug, name, category, image_url, price, rarity, sort_order) VALUES
...
-- ============================================================
-- 17. Grant 50 TaraTokens to all existing users (signup bonus)
-- ============================================================
INSERT INTO tara_tokens (user_id, balance, updated_at)
SELECT id, 50, now()
FROM users
...
INSERT INTO token_transactions (user_id, amount, reason, reference_id)
SELECT id, 50, 'admin_grant', 'prod-signup-bonus'
FROM users;
