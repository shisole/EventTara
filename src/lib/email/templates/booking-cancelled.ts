        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="padding:32px;">
              <h2 style="color:#dc2626;margin:0 0 8px;font-size:20px;">Booking Cancelled</h2>
              <p style="color:#555;margin:0 0 24px;font-size:15px;line-height:1.5;">
                Hey ${userName}, your booking for <strong>${eventTitle}</strong> has been cancelled as requested.
              </p>
              <p style="color:#555;margin:0 0 24px;font-size:15px;line-height:1.5;">
