    ...
    <footer className="bg-gray-100 dark:bg-gray-900 text-gray-500 dark:text-gray-400 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h4 className="text-gray-900 dark:text-white font-medium mb-3">Explore</h4>
            <div className="space-y-2 text-sm">
              <Link href="/events" className="block hover:text-gray-900 dark:hover:text-white">
                Browse Events
              </Link>
              <Link
              ...
              <Link href="/events?type=mtb" className="block hover:text-gray-900 dark:hover:text-white">
                Mountain Biking
              </Link>
              <Link
