  ...
  if (events.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-500">No past events yet. Your adventures will show up here!</p>
      </div>
    );
  }
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              ...
              <Link href={`/events/${e.eventId}`}>
                <h3 className="font-heading font-bold hover:text-coral-500">{e.eventTitle}</h3>
              </Link>
